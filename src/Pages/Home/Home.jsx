            ...
            <Table>
              <TableHead>
                <TableRow>
                  ...
                  <TableCell sx={{ color: "black" }}>Archivo LAS</TableCell>
                  <TableCell sx={{ color: "black" }}>
                    <TableSortLabel
                      active={orderBy === "description"}
                      direction={
                        orderBy === "description" ? sortDirection : "asc"
                      }
                  ...
                  <TableCell sx={{ color: "black" }}>
                    <TableSortLabel
                      ...
                      direction={
                        orderBy === "dateCreated" ? sortDirection : "asc"
                      }
                    ...
                    >
                      <TableCell sx={{ color: "black" }}>
                        <Box sx={{ display: "flex", alignItems: "center" }}>
                          ...
                          />
                          <Typography color="black">{well.name}</Typography>{" "}
                          {/* Cambiado a 'name' */}
                        </Box>
                      </TableCell>
                      <TableCell sx={{ color: "black" }}>
